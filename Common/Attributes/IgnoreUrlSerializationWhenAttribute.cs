...
namespace Trader.Common.Attributes
{
    ...
    public class IgnoreUrlSerializationWhenAttribute : Attribute
    {
        /// <summary>
        ...
        public IgnoreUrlSerializationWhenAttribute(){}

        public IgnoreUrlSerializationWhenAttribute(string valueToIgnore)
        {
